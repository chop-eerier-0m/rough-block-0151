...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/rough-block-0151)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/rough-block-0151
```

A live public deployment of this template is available at [https://rough-block-0151.templates.workers.dev](https://rough-block-0151.templates.workers.dev)
